<template>
    <div class="select-container" >
        ...
        <div class="mask" id="mask" @click="switchView"></div>
        <div class="options" id="options">
            <div v-for="st in status" class="cell" v-bind:vid="st.id" @click="onItemClick(st.id)">
                <text class="'name ' + (st.id==statusId?'current': '')">{{st.name}}</text>
                <image v-if="st.id==statusId" class="icon-curr-flag" v-bind:src="flagSrc" ></image>
            </div>
        </div>
        <div class="select" onclick="switchView">
            <text class="current-text">{{statusName}}</text>
            <image class="icon-arrow" id="arrow" v-bind:src="arrowSrc"></image>
        </div>
    </div>
